...
- `/portal` (dashboard)
- `/portal/map` (map MVP + bay grid + details panel)
...
- Map page uses a **professional MVP placeholder** (bay grid + details panel). Next iteration is Mapbox rendering of bay geojson/lat/lng.
