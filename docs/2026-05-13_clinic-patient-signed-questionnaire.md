...
- Before signing, it shows 10 doctor questions as Yes / No choices only.
- Free-text answer fields were removed from the questionnaire UI.
- A drawn client signature is required before saving. On iPad/tablet, the patient signs directly inside the signature box with a finger or Apple Pencil.
