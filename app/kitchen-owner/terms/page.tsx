...
const termsData: TermsSection[] = [
  ...
  },
  {
    ...
    content: [
      ...
      '• 999 AED per sensor - includes hardware, Etisalat NB-IoT SIM, professional installation, configuration, and staff training',
      '',
  ...
  },
  {
    ...
    content: [
      ...
      '',
      'EXCLUSIONS:',
      '• Etisalat network outages or NB-IoT coverage issues',
  ...
  },
  {
    ...
    content: [
      ...
      '• Etisalat NB-IoT network is used for connectivity',
      '',
      'UAE DATA RESIDENCY:',
  ...
  },
  {
    ...
    content: [
      ...
      '• VisionDrive is not liable for Etisalat network outages or AWS service interruptions',
      '',
      'INDEMNIFICATION:',
