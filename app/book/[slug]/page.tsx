...
const copy = {
  ...
  ru: {
    ...
    confirmationSuffix: 'Специалист подтвердит запись, если потребуется уточнение.',
    instantConfirmationSuffix: 'Запись подтверждена. Если нужно что-то изменить, свяжитесь со специалистом.',
    privateLink: 'Приватная ссылка для записи',
    bookWith: 'Запись в {practice}',
    fallbackPractice: 'практику',
    subtitle:
      'Выберите услугу, доступное время и оставьте данные. Информация попадёт напрямую специалисту.',
    secure: 'Приватная запись в рамках практики',
    ...
    noSlots: 'Доступных слотов нет. Попробуйте позже или свяжитесь со специалистом.',
    ...
    email: 'Email',
    notes: 'Комментарий для специалиста',
    ...
    yes: 'Да',
    no: 'Нет',
    consent: 'Я согласен(на), чтобы практика хранила мои данные для записи и карты пациента.',
