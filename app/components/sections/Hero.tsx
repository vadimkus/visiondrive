...
export default function Hero() {
  ...
  return (
    <section className="relative flex items-center justify-center min-h-[calc(100vh-200px)] py-4 sm:py-8">
      <div className="relative z-10 mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 text-center">
        ...
        >
          ...
          <p className="text-base sm:text-lg text-gray-600 mb-4 sm:mb-6 md:mb-8 max-w-2xl mx-auto px-4" dir={language === 'ar' ? 'rtl' : 'ltr'}>
            {t.hero.subtitle}
          </p>
          <div className="px-4">
