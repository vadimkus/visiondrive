...
export default function Hero() {
  ...
  return (
    <section className="relative flex items-center justify-center min-h-[calc(100vh-260px)] py-2 sm:py-4 pb-1 sm:pb-2">
      <div className="relative z-10 mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 text-center">
        ...
        >
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold text-gray-900 mb-3 sm:mb-5 md:mb-6 px-2" dir={language === 'ar' ? 'rtl' : 'ltr'}>
            {t.hero.title}{' '}
