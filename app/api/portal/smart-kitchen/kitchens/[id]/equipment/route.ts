...
// GET /api/portal/smart-kitchen/kitchens/[id]/equipment - List equipment for a kitchen
export async function GET(
  ...
  try {
    ...
    const response = await fetch(`${API_URL}/kitchens/${kitchenId}/equipment`, {
...
// POST /api/portal/smart-kitchen/kitchens/[id]/equipment - Add equipment to a kitchen
