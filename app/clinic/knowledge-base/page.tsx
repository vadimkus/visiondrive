...
const articlesEn: Article[] = [
  ...
  },
  {
    ...
    steps: [
      ...
      'When signal is weak, type notes into Offline note draft. It stays on that device until you paste it into a patient or visit note.',
...
const articlesRu: Article[] = [
  ...
  },
  {
    ...
    steps: [
      ...
      'При слабой связи пишите в Офлайн-черновик. Он хранится на этом устройстве, пока вы не перенесёте текст в карту пациента или заметку визита.',
