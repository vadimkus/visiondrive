...
const articlesRu: Article[] = [
  ...
  },
  {
    ...
    steps: [
      ...
      'Не добавляйте вместимость группы, списки участников и лист ожидания, пока курсы/воркшопы не станут повторяемой выручкой.',
    ],
    link: '/clinic/appointments/availability',
  },
  {
  ...
  },
  {
    ...
    summary:
      'Используйте раздел Instagram-лиды, чтобы фиксировать лиды, готовить проверенные ответы, отправлять отслеживаемые ссылки записи и вести клиента к повтору, пакетам и абонементу.',
    steps: [
  ...
  },
  {
    ...
    steps: [
      'Считайте Instagram входной дверью для частной практики в красоте, wellness и эстетике.',
