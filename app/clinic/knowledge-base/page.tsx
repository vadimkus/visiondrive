...
const articlesRu: Article[] = [
  ...
  },
  {
    ...
    steps: [
      ...
      'Для ручных касаний создайте CRM-запись и выберите тип WhatsApp или электронная почта.',
  ...
  },
  {
    ...
    steps: [
      'Откройте Инвентаризацию и начните новый пересчёт. Сессия зафиксирует все активные позиции склада.',
      'Введите фактическое количество каждой позиции из рабочей сумки, кейса или полки.',
      'Если фактическое количество отличается от ожидаемого, выберите причину: просрочено, повреждено, потеряно, найдено или коррекция пересчёта.',
      'Завершайте инвентаризацию только после пересчёта всех строк. Система создаст корректирующие движения и обновит остатки.',
    ],
    link: '/clinic/stock-takes',
  },
  {
  ...
  },
  {
    ...
    steps: [
      ...
      'Комиссия эквайринга не увеличивает баланс пациента; это внутренняя себестоимость приёма платежа.',
  ...
  },
  {
    ...
    summary: 'Используйте чеклист съёмки, чтобы прогресс был сравнимым, а согласие на маркетинг было явным.',
    steps: [
      'Откройте карту пациента и вкладку Фото.',
      'По возможности привяжите фото к визиту, чтобы появился процедурный контекст.',
      'Перед съёмкой отметьте тот же свет, угол, расстояние, чистый фон и понятную зону обработки.',
  ...
  },
  {
    ...
    steps: [
      ...
      'В кабинете пациента видны сохранённый текст и ссылка на документ без внутренних заметок.',
    ],
    link: '/clinic/procedures',
  },
  {
  ...
  },
  {
    ...
    steps: [
      'Откройте завершённую запись и отправьте запрос отзыва из блока Репутация.',
  ...
  },
  {
    ...
    steps: [
      ...
      'Выберите Возврат у оплаченного платежа, укажите сумму и причину. Исходная оплата остаётся, а система создаёт отдельную строку возврата.',
  ...
  },
  {
    ...
    summary:
      'Просмотры ссылки, источники/UTM, незавершённые сессии, завершённые записи и конверсия по процедурам.',
    steps: [
      'Поделитесь публичной ссылкой из Панели после включения онлайн-записи.',
      'Добавляйте источник или UTM-параметры, когда делитесь ссылкой в Instagram, Google или у партнёра.',
