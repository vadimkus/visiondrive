...
const capabilityGroupsRu: CapabilityGroup[] = [
  ...
  },
  {
    ...
    features: [
      ...
      'Ручная история WhatsApp и email, плюс структурированный журнал звонков',
  ...
  },
  {
    ...
    features: [
      ...
      'Финансовая панель: отчёт P&L v2, прибыльность процедур, аналитика услуг, план выручки и загрузка расписания',
    ],
  },
  {
    ...
    features: [
      'Складские позиции с SKU/штрихкодом, остатком, минимумом, себестоимостью, поставщиком и предупреждениями о низком остатке',
      'Материальная карта процедуры с себестоимостью расходников и автоматическим списанием после визита',
  ...
  },
  {
    ...
    features: [
      'Статистика дашборда, пошаговая настройка, умные пустые состояния и упрощённый режим навигации',
  ...
  },
  {
    ...
    features: [
      ...
      'Старые непрофильные разделы изолированы от активного Practice OS',
    ],
  },
]
...
const articlesRu: Article[] = [
  ...
  },
  {
    ...
    steps: [
      ...
      'После сохранения имя появится в шапке рабочего места и на дашборде.',
  ...
  },
  {
    ...
    steps: [
      ...
      'Сохраните расчёт, затем скачайте PDF или отправьте готовый текст через WhatsApp или email.',
  ...
  },
  {
    ...
    summary:
      'Используйте раздел Growth, чтобы фиксировать Instagram-лиды, готовить проверенные ответы, отправлять отслеживаемые ссылки записи и вести клиента к повтору, пакетам и абонементу.',
    steps: [
      'Откройте Instagram Growth в разделе Рост.',
      'Создайте лид: Instagram-аккаунт, имя, интересующая услуга, кампания и контекст исходного сообщения.',
  ...
  },
  {
    ...
    steps: [
      'Считайте Instagram входной дверью для частной beauty, wellness и aesthetic-практики.',
      'Используйте Growth для лидов до записи, воронку записи для конверсии каналов и удержание для повторных визитов.',
      'Не превращайте Growth в обычный планировщик соцсетей; заносите только реальные клиентские диалоги, которые могут стать записью.',
      'Когда лид записывается, источник пациента отмечается как Instagram, а лид хранит след конверсии.',
      'Каждый день проверяйте задачи Growth: новые лиды, ответы без ссылки записи, рекомендации после визита, предложения пакета или абонемента.',
    ],
    link: '/clinic/growth',
  },
  {
  ...
  },
  {
    ...
    steps: [
      ...
      'Примите заказ, когда товар пришёл.',
  ...
  },
  {
    ...
    steps: [
      ...
      'Сохраните продажу. Товар спишется со склада, а платёж продажи попадёт в финансовую выручку.',
