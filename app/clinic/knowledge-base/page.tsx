...
const articlesEn: Article[] = [
  ...
  {
    id: 'public-practitioner-profile',
    category: 'Appointments',
    title: 'Share your public practitioner profile',
    summary: 'Use one lightweight profile page for services, booking, approved reviews, public-safe photos, and policies.',
    steps: [
      'Open Dashboard and copy Public profile from the Google / Instagram booking links card.',
      'Share the profile in Instagram bio, Google Business Profile, WhatsApp, or a simple website button.',
      'Only active services, published reviews, and photos with marketing/public-use consent appear on the page.',
      'Clients can review policies and tap Book now to enter the existing login-free booking flow.',
    ],
    link: '/clinic',
  },
  {
...
const articlesRu: Article[] = [
  ...
  },
  {
    id: 'public-practitioner-profile',
    category: 'Записи',
    title: 'Поделитесь публичным профилем специалиста',
    summary: 'Одна лёгкая страница с услугами, записью, опубликованными отзывами, безопасными фото и правилами.',
    steps: [
      'Откройте Dashboard и скопируйте Публичный профиль в карточке ссылок Google / Instagram.',
      'Разместите профиль в Instagram bio, Google Business Profile, WhatsApp или на простом сайте.',
      'На странице видны только активные услуги, опубликованные отзывы и фото с согласием на публичное использование.',
      'Клиент читает правила и нажимает Записаться, чтобы перейти в существующую запись без логина.',
    ],
    link: '/clinic',
  },
  {
